...
AS $$
DECLARE
  project_url TEXT := 'https://hjighagntnvkodhxvonq.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImhqaWdoYWdudG52a29kaHh2b25xIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTcxNjAwODU0NiwiZXhwIjoyMDMxNTg0NTQ2fQ.jHNVCSDtHkjD5quCtMJ0D2r9sQYhUi6zrVuKv1MsJg4'; -- full access needed for http request to storage
